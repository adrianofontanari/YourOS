---
tags: person, people/work, youros/core
aliases: [Adriano Fontanari, Adriano]
---
# Adriano Fontanari
---
...
## Contact Info
- Education: 
- Background (skills, position, company): 
- Location:
- Interests: 
- First Interaction:
...
```dataview
Table
Where contains(string(file.outlinks), "Adriano Fontanari")
Group by file.link as Entries
```

```tracker
searchType: text
searchTarget: 'Adriano Fontanari'
line:
    title: Linked Notes
    fillGap: true
```
